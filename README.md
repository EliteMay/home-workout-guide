...
ダンベル種目は、フォーム図 → 手順 → 回数目安 → 注意点の順で確認できます。回数よりも、痛みなく同じフォームを再現できることを優先します。
...
- `index.html` — 本文、ナビゲーション、ダンベル種目のフォーム図
- `styles.css` — レイアウト、図、レスポンシブ、アクセシビリティ対応
...
- フォーム図は初心者が動きの方向を理解するための簡易図で、身体の細かな関節角度を医学的に再現するものではありません。
